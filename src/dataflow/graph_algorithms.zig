...
//!   - canReach:        types/ownership_types.zig, types/cpp_fp_types.zig
//!   - findFreePath:    types/ownership_types.zig, types/cpp_fp_types.zig
//!   - addFlowEdge:     types/ownership_types.zig
//!   - hashValues:      types/memory_graph_types.zig
