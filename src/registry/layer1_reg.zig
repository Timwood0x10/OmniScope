...
pub const layer1_functions = [_]types.FunctionSemantics{
    ...
    // NOTE: __memcpy_chk, __strcpy_chk, __memmove_chk are FORTIFIED variants
    // — they are MORE safe than their unfortified counterparts, not less.
    // They are filtered by ffi_noise_filter.zig and ffi_types.zig safe lists.
