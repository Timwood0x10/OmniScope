...
pub const RiskKind = enum {
    ...
    cpp_allocator,
    /// Dynamic loading operations (dlopen, dlsym, dlclose).
    /// Handle lifecycle: dlopen creates handle, dlsym extracts symbol, dlclose releases.
    /// Use-after-free when using symbols after dlclose.
    dynamic_loading,
    /// Java Native Interface functions (JNI).
    /// JNI references require NewGlobalRef/DeleteGlobalRef pairing.
    /// Local refs auto-freed on native method return, global refs require explicit delete.
    jni,
    /// Python C API functions.
    /// Py_INCREF/Py_DECREF for reference counting.
    /// GIL must be held when calling Python C API from other threads.
    python_c_api,
    /// Signal handling functions (signal, sigaction, sigprocmask).
    /// Signal handlers have restricted functionality - only async-signal-safe functions allowed.
    signal_handler,
    /// Thread management functions (pthread_create, pthread_join, pthread_mutex_*).
    /// Resource lifecycle: pthread_create transfers ownership, pthread_join releases.
    thread_mgmt,
    /// Process management functions (fork, execvp, waitpid).
    /// Fork creates new process with copy-on-write memory, execvp replaces process image.
    process_mgmt,
};
...
pub const SemanticRegistry = struct {
    ...
    const layer1 = [_]FunctionSemantics{
        ...
        // Dynamic Loading - HIGH (handle lifecycle management)
        .{
            .pattern = "dlopen",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Open dynamic library - returns handle, must dlclose to release",
        },
        .{
            .pattern = "dlsym",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get symbol from dynamic library - returns pointer, invalid after dlclose",
        },
        .{
            .pattern = "dlclose",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Close dynamic library - invalidates symbols from dlsym",
        },
        .{
            .pattern = "dlerror",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Get dynamic loading error message",
        },

        // JNI Functions - HIGH (reference lifecycle management)
        .{
            .pattern = "JNI_OnLoad",
            .match_type = .exact,
            .kind = .jni,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "JNI library load - verify VM version, register native methods",
        },
        .{
            .pattern = "JNI_OnUnload",
            .match_type = .exact,
            .kind = .jni,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "JNI library unload - cleanup global references",
        },
        .{
            .pattern = "FindClass",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Find Java class - returns local ref, check for NULL",
        },
        .{
            .pattern = "GetMethodID",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get JNI method ID - returns NULL on error, cache for performance",
        },
        .{
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get JNI static method ID - returns NULL on error",
        },
        .{
            .pattern = "GetFieldID",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get JNI field ID - returns NULL on error",
        },
        .{
            .pattern = "GetStaticFieldID",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get JNI static field ID - returns NULL on error",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Call JNI void method - check ExceptionCheck after call",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Call JNI int method - check ExceptionCheck after call",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Call JNI object method - returns local ref, check ExceptionCheck",
        },
        .{
            .pattern = "CallStaticVoidMethod",
            .match_type = .exact,
            .kind = .jni,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Call JNI static void method - check ExceptionCheck after call",
        },
        .{
            .pattern = "NewStringUTF",
            .match_type = .exact,
            .kind = .jni,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create Java String from UTF-8 - returns local ref, check for NULL",
        },
        .{
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get UTF-8 chars from Java String - must ReleaseStringUTFChars",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Release UTF-8 chars - paired with GetStringUTFChars",
        },
        .{
            .pattern = "NewByteArray",
            .match_type = .exact,
            .kind = .jni,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create Java byte array - returns local ref, check for NULL",
        },
        .{
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get byte array elements - must ReleaseByteArrayElements",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Release byte array elements - paired with GetByteArrayElements",
        },
        .{
            .pattern = "NewGlobalRef",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create global ref - must DeleteGlobalRef to avoid leak",
        },
        .{
            .pattern = "DeleteGlobalRef",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = true,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Delete global ref - paired with NewGlobalRef, use-after-free if used after",
        },
        .{
            .pattern = "NewLocalRef",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create local ref - auto-freed when native method returns",
        },
        .{
            .pattern = "DeleteLocalRef",
            .match_type = .exact,
            .kind = .jni,
            .severity = .medium,
            .consumes_ownership = true,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Delete local ref - optional, auto-freed anyway",
        },
        .{
            .pattern = "AttachCurrentThread",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Attach thread to JVM - must DetachCurrentThread on exit",
        },
        .{
            .pattern = "DetachCurrentThread",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = true,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Detach thread from JVM - paired with AttachCurrentThread",
        },
        .{
            .pattern = "RegisterNatives",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Register native methods - signature mismatch causes crashes",
        },
        .{
            .pattern = "ExceptionCheck",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Check for pending exception - must be called after JNI calls",
        },
        .{
            .pattern = "ExceptionDescribe",
            .match_type = .exact,
            .kind = .jni,
            .severity = .low,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Print exception description - debugging aid",
        },
        .{
            .pattern = "ExceptionClear",
            .match_type = .exact,
            .kind = .jni,
            .severity = .high,
            .consumes_ownership = true,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Clear pending exception - must be called before new JNI calls",
        },

        // Python C API - HIGH (reference counting and GIL management)
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Initialize Python interpreter - call once at startup",
        },
        .{
            .pattern = "Py_Finalize",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Finalize Python interpreter - call once at shutdown",
        },
        .{
            .pattern = "Py_IncRef",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Increment Python object reference count",
        },
        .{
            .pattern = "Py_DecRef",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Decrement Python object reference count - use-after-free if called on freed object",
        },
        .{
            .pattern = "Py_INCREF",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Increment Python object reference count (legacy macro)",
        },
        .{
            .pattern = "Py_DECREF",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Decrement Python object reference count (legacy macro)",
        },
        .{
            .pattern = "Py_XINCREF",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Increment reference count (NULL-safe)",
        },
        .{
            .pattern = "Py_XDECREF",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Decrement reference count (NULL-safe)",
        },
        .{
            .pattern = "Py_BuildValue",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create Python object from C value - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyArg_ParseTuple",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Parse Python tuple arguments - returns false on error",
        },
        .{
            .pattern = "PyArg_ParseKeywords",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Parse Python keyword arguments - returns false on error",
        },
        .{
            .pattern = "PyObject_Call",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Call Python callable - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyObject_CallObject",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Call Python object - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyObject_CallFunction",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Call Python function - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyModule_Create",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create Python module - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyImport_ImportModule",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Import Python module - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyImport_Import",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Import Python module (object form) - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyErr_SetString",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .low,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Set Python error - indicates exception state",
        },
        .{
            .pattern = "PyErr_Occurred",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Check if error occurred - returns NULL or exception object",
        },
        .{
            .pattern = "PyErr_Fetch",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Fetch and clear error - returns error indicators",
        },
        .{
            .pattern = "PyErr_Restore",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = true,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Restore error state - consumes references",
        },
        .{
            .pattern = "PyGILState_Ensure",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .high,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Ensure GIL is held - must PyGILState_Release, deadlock risk if nested",
        },
        .{
            .pattern = "PyGILState_Release",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .high,
            .consumes_ownership = true,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Release GIL - paired with PyGILState_Ensure",
        },
        .{
            .pattern = "PyEval_CallObject",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Call callable with args - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyEval_InitThreads",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Initialize thread state - deprecated in Python 3.7+",
        },
        .{
            .pattern = "PyList_New",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create new Python list - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyDict_New",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create new Python dict - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyTuple_New",
            .match_type = .exact,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create new Python tuple - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyTuple_Pack",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create Python tuple from C values - returns new reference, check for NULL",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Convert Python int to C long - check PyErr_Occurred on error",
        },
        .{
            .pattern = "PyLong_FromLong",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create Python int from C long - returns new reference, check for NULL",
        },
        .{
            .pattern = "PyFloat_AsDouble",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Convert Python float to C double - check PyErr_Occurred on error",
        },
        .{
            .pattern = "PyCapsule_New",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Create capsule (opaque pointer wrapper) - returns new reference",
        },
        .{
            .pattern = "PyCapsule_GetPointer",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Get pointer from capsule - check for NULL, validate capsule name",
        },
        .{
            .pattern = "PyCapsule_SetDestructor",
            .match_type = .exact,
            .kind = .python_c_api,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Set capsule destructor - destructor called when capsule freed",
        },

        // Signal Handler - MEDIUM (async-signal-safe restrictions)
        .{
            .pattern = "signal",
            .match_type = .exact,
            .kind = .signal_handler,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Set signal handler - only async-signal-safe functions allowed in handler",
        },
        .{
            .pattern = "sigaction",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Set signal handler with options - preferred over signal()",
        },
        .{
            .pattern = "sigprocmask",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Change signal mask - block/unblock signals",
        },
        .{
            .pattern = "sigwait",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Wait for signal - requires blocked signals",
        },
        .{
            .pattern = "sigsuspend",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Atomically change signal mask and wait - temporary mask change",
        },

        // Thread Management - MEDIUM (lifecycle management)
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Create new thread - thread must be joined or detached",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Wait for thread termination - paired with pthread_create",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Detach thread - auto-cleanup, cannot pthread_join after",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Lock mutex - deadlock risk if not unlocked, double-lock risk",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Unlock mutex - paired with lock, unlock without lock = UB",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Initialize mutex - must pthread_mutex_destroy to cleanup",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Destroy mutex - locked mutex = UB",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Wait for condition - atomically unlocks mutex, spurious wakeup possible",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Signal condition - wake one waiting thread",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Broadcast condition - wake all waiting threads",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Read lock rwlock - multiple readers allowed",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Write lock rwlock - exclusive access",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Unlock rwlock - paired with rdlock or wrlock",
        },

        // Process Management - HIGH (fork risks)
        .{
            .pattern = "fork",
            .match_type = .exact,
            .kind = .process_mgmt,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Fork process - double-free risk in child before exec",
        },
        .{
            .pattern = "vfork",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Fork with minimal memory - vfork until exec in child",
        },
        .{
            .pattern = "execve",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = true,
            .description = "Execute program - replaces process image, command injection risk",
        },
        .{
            .pattern = "execv",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = true,
            .description = "Execute program (array form) - command injection risk",
        },
        .{
            .pattern = "execl",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = true,
            .description = "Execute program (list form) - command injection risk",
        },
        .{
            .pattern = "execvp",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = true,
            .description = "Execute with PATH search - command injection risk",
        },
        .{
            .pattern = "waitpid",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Wait for process termination - consumes zombie process",
        },
        .{
            .pattern = "wait",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Wait for any child - consumes zombie process",
        },
        .{
            .pattern = "kill",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = true,
            .description = "Send signal to process - privilege escalation risk",
        },

        // Network I/O - Additional functions
        .{
            .pattern = "getaddrinfo",
            .match_type = .exact,
            .kind = .network_io,
            ...
            .requires_null_check = true,
            .requires_taint_check = true,
            .description = "DNS lookup and service resolution - must freeaddrinfo to release",
        },
        .{
            .pattern = "getnameinfo",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Reverse DNS lookup - convert address to hostname",
        },
        .{
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Free address info - paired with getaddrinfo",
        },
        .{
            .pattern = "gethostbyname",
            .match_type = .exact,
            .kind = .network_io,
            .severity = .medium,
            .consumes_ownership = false,
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "DNS lookup (deprecated) - returns static pointer, not thread-safe",
        },
        .{
            ...
            .requires_null_check = true,
            .requires_taint_check = false,
            .description = "Reverse DNS lookup (deprecated) - returns static pointer",
        },
        .{
            .pattern = "inet_ntoa",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Convert IP to string - returns static buffer, not thread-safe",
        },
        .{
            .pattern = "inet_ntop",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Convert binary IP to string - thread-safe version",
        },
        .{
            .pattern = "inet_pton",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Convert string IP to binary - returns -1 on error",
        },
        .{
            .pattern = "setsockopt",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Set socket option - check return value for errors",
        },
        .{
            .pattern = "getsockopt",
            .match_type = .exact,
            ...
            .requires_null_check = false,
            .requires_taint_check = false,
            .description = "Get socket option - check return value for errors",
        },
