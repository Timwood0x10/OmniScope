...
test "SemanticRegistry: layer counts" {
    try std.testing.expectEqual(@as(usize, 44), registry.SemanticRegistry.layer1Count());
    ...
    try std.testing.expectEqual(@as(usize, 267), registry.SemanticRegistry.totalCount());
}
