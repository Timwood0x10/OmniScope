...
```
  ...
  Issues found:                35 (v0.1.7 更新)
```

> **v0.1.5 → v0.1.7 变化**: Issues 从 48 → **35**（FP 抑制 + 精度提升），FFI Boundaries 从未统计 → **1382**
...
- v0.1.7 检测到 2 个所有权不匹配（v0.1.5 为 0，因为 FIX-3 修复了配对逻辑）
