...
### v0.1.6 vs v0.1.7 关键指标对比

| 指标 | v0.1.6 | v0.1.7 (当前) | 变化 |
|------|--------|---------------|------|
...
- v0.1.7: **4 issues detected**, 38 ptrs tracked (✅ FIX-1 恢复)
