...
> **v0.1.8 Update**: After the memory_graph function name fix, this file now detects **404 issues**. The manually verified findings in this report remain valid. Newly detected issues have not yet been classified through the evidence ladder

> **Based on OmniScope v0.1.8 static analysis of curl/libcurl 8.x**
...
- **L0 (28.6%)**: Broad coverage, pending verification leads



**This distribution fully meets expectations for real-world security audits: a few high-quality findings + many leads pending verification.**
