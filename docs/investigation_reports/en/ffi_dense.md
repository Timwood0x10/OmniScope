...
> **v0.1.5 → v0.1.7 Change**: Issues from 25 → **7** (FP suppression improved precision). Added Ptrs Tracked and FFI Bounds statistics.
...
> v0.1.5 reported 14 issues; v0.1.7 reports **4 issues** (~90% precision post-FP suppression)
...
> v0.1.5 reported 7 issues; v0.1.7 reports **1 issue** (mostly defensive coding FP)
```
...
> v0.1.5 reported 4 issues; v0.1.7 reports **2 issues**
```
...
| Metric | v0.1.5 | v0.1.7 (Current) | Change |
|--------|--------|------------------|--------|
...
### 5.1 v0.1.7 Improvement Effectiveness
...
- OmniScope detection logs from actual v0.1.7 execution
