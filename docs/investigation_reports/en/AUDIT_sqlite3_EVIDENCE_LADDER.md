# 🔬 SQLite3 - Evidence Ladder Audit Report (Real Project)

> **v0.1.8 Update**: After the memory_graph function name fix, this file now detects **1508 issues**. The manually verified findings in this report remain valid. Newly detected issues have not yet been classified through the evidence ladder.**Project**: SQLite3 v3.49.0.0 (amalgamation)  

**Scale**: ~210K lines | **Functions**: 3,346 | **Issues**: 136  
...
| **Location** | [sqlite3.c L183353-L183365](https://www.sqlite.org/src/artifact?ci=trunk&filename=src/main.c&ln=183353) |
...
| **Function** | `sqlite3ThreadCreate()` |

| **Location** | [sqlite3.c L34473-L34507](https://www.sqlite.org/src/artifact?ci=trunk&filename=src/thread.c&ln=34473) |
...
**Version**: v2.0 (Evidence Ladder Format - Real Project)  
