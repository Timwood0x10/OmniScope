# 🔬 posix_ffi_bugs.c - Evidence Ladder Audit Report

> **v0.1.8 Update**: After the memory_graph function name fix, this file now detects **15 issues**. The manually verified findings in this report remain valid. Newly detected issues have not yet been classified through the evidence ladder.**Project**: `corpus/red_team_test/posix_ffi_bugs.c`  

**Language**: C (POSIX API) | **Lines**: 243 | **Functions**: 48  
...
## ⚠️ CRITICAL Issues (4) - Evidence Ladder
...
| **Function** | `POSIX_06_create_Thread_Dangling_Arg()` |

| **Location** | [L104-L111](../../corpus/red_team_test/posix_ffi_bugs.c#L104-L111) |
...
| **Function** | `POSIX_11_use_After_Detach()` |

| **Location** | [L186-L192](../../corpus/red_team_test/posix_ffi_bugs.c#L186-L192) |
