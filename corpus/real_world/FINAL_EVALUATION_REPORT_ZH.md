# OmniScope v0.1.4 — 最终测评报告

> **日期**: 2026-04-23
> **版本**: v0.1.4（C++ 支持 + jsoncpp/abseil 真实项目测试 + Confidence 分级 + 7层 FP 消减 + 基线回归自动化）
...
OmniScope v0.1.4 证明了 **静态分析在真实世界 C/C++ 代码上的精度可以在关键 bug 类别（memory leak、null dereference）上达到接近零假阳性率**，通过以下组合实现：
