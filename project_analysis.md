...
> **分析版本**：v0.1.6（VERSION 文件）/ v0.1.6（README 描述）
> **分析日期**：2026-05-01
...
- **所有权追踪支持跨函数**（v0.1.6 的主要改进），但其他分析 pass 主要是**过程内分析**
...
- `VERSION` 文件记录为 `0.1.6`
- `README.md` 描述的是 `v0.1.6` 的功能
- `main.zig` 中 SARIF 输出硬编码 `"0.1.6"`
- `CHANGELOG.md` 记录了 v0.1.5 和 v0.1.6 的变更
...
虽然 v0.1.6 路线图规划了 Binary Bridge（基于 RetDec/Binary Lifting），但尚未实现。
